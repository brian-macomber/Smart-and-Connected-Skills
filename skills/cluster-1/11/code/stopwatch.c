...
static void test_alpha_display()
{
    ...
    while (1)
    {
        ...
        displaybuffer[3] = binaries[(int)nums[0]];
        displaybuffer[2] = binaries[(int)nums[1]];
        displaybuffer[1] = binaries[(int)nums[2]];
        displaybuffer[0] = binaries[(int)nums[3]];
...
static void timer_evt_task(void *arg)
{
    while (1)
    {
        ...
        if (evt.flag == 1)
        {
            // incremement counter to be displayed
            //wrap after max number
            if (counter < 99)
            {
                counter++;
            }
...
static void button_task()
{
    ...
    while (1)
    {
        ...
        if (button_flag)
        {
            vTaskDelay(50); //test to make button less sensitive
